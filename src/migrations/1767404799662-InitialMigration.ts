...
export class InitialMigration1767404799662 implements MigrationInterface {
    name = 'InitialMigration1767404799662'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "expense_debt" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "groupId" uuid NOT NULL, "fromUserId" uuid NOT NULL, "toUserId" uuid NOT NULL, "amount" numeric(10,2) NOT NULL DEFAULT '0', "isSettled" boolean NOT NULL DEFAULT false, "settledAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_77d7d8afc23ec3eb88b69389fdd" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_c99d8dd88487e2d142cacd6319" ON "expense_debt" ("groupId", "fromUserId", "toUserId") `);
        await queryRunner.query(`CREATE TABLE "expense_group" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "referenceId" character varying NOT NULL, "name" character varying NOT NULL, "currency" character varying, "totalExpenses" numeric(10,2) NOT NULL DEFAULT '0', "status" character varying NOT NULL DEFAULT 'active', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_add783a3607d574282fdea67ae7" UNIQUE ("referenceId"), CONSTRAINT "PK_b50aa03fde43af4d14eb84e6c2d" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "expense_debt" ADD CONSTRAINT "FK_a46074c8836c45f83a9ab72e8f3" FOREIGN KEY ("fromUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "expense_debt" ADD CONSTRAINT "FK_58c89662160bbc1c1c8ea4c3d72" FOREIGN KEY ("toUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "expense_contributor" ADD CONSTRAINT "FK_545cadb0f79b3b48905af36277c" FOREIGN KEY ("memberId") REFERENCES "expense_group_member"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "expense_participant" ADD CONSTRAINT "FK_588c5b44076ac331de9fe013924" FOREIGN KEY ("memberId") REFERENCES "expense_group_member"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
